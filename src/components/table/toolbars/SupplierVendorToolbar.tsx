...
import CreateSupplierVendorDialog from "@/components/inventory/create/CreateSupplierVendorDialog";

interface SupplierVendorToolbarProps<TData> {
  table: Table<TData>;
}

const SupplierVendorToolbar = <TData,>({
  table,
}: SupplierVendorToolbarProps<TData>) => {
  return (
    <CardHeader>
      <TooltipProvider>
        <div className="flex flex-col items-center space-y-4 md:flex-row justify-between">
...
export default SupplierVendorToolbar;
