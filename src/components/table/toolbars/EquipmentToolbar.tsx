...
import CreateEquipmentDialog from "@/components/inventory/create/CreateEquipmentDialog";

interface EquipmentToolbarProps<TData> {
  table: Table<TData>;
}

const EquipmentToolbar = <TData,>({ table }: EquipmentToolbarProps<TData>) => {
  return (
    <CardHeader>
      <TooltipProvider>
          ...
          <div className="space-x-4">
            ...
            <TooltipButton
              ...
              onClick={() => {
                ...
                exportSelectedRows(selectedRows, "equipment.xlsx", "xlsx");
              }}
            >
              <Upload />
              Export
