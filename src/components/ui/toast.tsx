...
const Toast = React.forwardRef<
  ...
  ToastProps
>(({ className, variant, progressColor, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute bottom-0 left-0 h-1 w-full animate-[toast-progress_3000ms_linear_forwards]",
          getProgressColor()
        )}
      />
    </ToastPrimitives.Root>
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity group-hover:opacity-100 focus:opacity-100 focus:outline-none disabled:pointer-events-none",
      className
    )}
    toast-close=""
    {...props}
